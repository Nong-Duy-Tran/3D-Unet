...
from oasis_label import VALID_LABEL_MODES, build_label, get_class_names
...
def preprocess_volume(
    ...
    img = reorient_to_ras(img) # Usually not correct and need reorient to RAS manually in step 7
    ...
    # 7. Reorient to team convention (enabled by default)
