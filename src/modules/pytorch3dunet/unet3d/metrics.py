...
from src.modules.pytorch3dunet.unet3d.losses import compute_per_channel_dice
from src.modules.pytorch3dunet.unet3d.seg_metrics import Accuracy, AveragePrecision
from src.modules.pytorch3dunet.unet3d.utils import convert_to_numpy, get_logger
...
def get_evaluation_metric(config):
    ...
    def _metric_class(class_name):
        m = importlib.import_module("src.modules.pytorch3dunet.unet3d.metrics")
