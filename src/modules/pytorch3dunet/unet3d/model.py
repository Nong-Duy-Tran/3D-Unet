...
from src.modules.pytorch3dunet.unet3d.buildingblocks import DoubleConv, ResNetBlock, ResNetBlockSE, create_decoders, create_encoders
from src.modules.pytorch3dunet.unet3d.utils import get_class, number_of_features_per_level
...
def get_model(model_config):
    model_class = get_class(model_config["name"], modules=["src.modules.pytorch3dunet.unet3d.model"])
