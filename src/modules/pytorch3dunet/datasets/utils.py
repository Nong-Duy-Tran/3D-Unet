...
from src.modules.pytorch3dunet.unet3d.config import TorchDevice, os_dependent_dataloader_kwargs
from src.modules.pytorch3dunet.unet3d.utils import get_class, get_logger
...
def _loader_classes(class_name):
    modules = ["src.modules.pytorch3dunet.datasets.hdf5", "src.modules.pytorch3dunet.datasets.dsb", "src.modules.pytorch3dunet.datasets.utils"]
