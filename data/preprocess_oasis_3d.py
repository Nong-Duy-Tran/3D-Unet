...
from data.oasis_labels import VALID_LABEL_MODES, build_label, get_class_names
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_dir", type=str, default="./data/processed_oasis_3d",
    ...
    parser.add_argument(
        "--skull_strip", action="store_true", default=True,
        help="Apply HD-BET skull stripping (no fast mode, no TTA)",
    )
    parser.add_argument(
        "--hdbet_device", type=str, default="cuda", choices=["cpu", "cuda"],
